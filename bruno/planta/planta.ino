...
#define UMIDPIN D0    // Pino do sensor umidade de solo.
#define DHTPIN  D4    // Pino do sensor DHT11 (temperatura e umidade do ar).
#define LDRPIN  A0    // Pino do sensor LDR (luminosidade).

// Configuracao da rede WiFi.
const int HTTP_PORT= 80;
const char* NOME_REDE = "SOFTVILLE"; // ATUALIZAR
const char* SENHA = "softville:-)"; // ATUALIZAR

// Configuracao do ThingSpeak.
const char* TS_HOST = "api.thingspeak.com";
const char* TS_URL = "/update";
const char* TS_API_KEY = "D7XV7H7VNIBNBZDJ"; // ATUALIZAR

// Configuracao do IFTTT.
const char* IFTTT_HOST = "maker.ifttt.com";
const char* IFTTT_URL = "/trigger/umidade_baixa/with/key/"; // ATUALIZAR
const char* IFTTT_API_KEY = "bHQEqYyHJG6R46QKIK3Qc8"; // ATUALIZAR
...
int temp = 0;
int lumin = 0;
bool alertarumidSoloBaixa = false;
...
void leUmidadeDoSolo() {
  int umidadeAtual = digitalRead(UMIDPIN); // Le o valor da entrada analogica.
  alertarumidSoloBaixa = umidSolo == 0 && umidadeAtual == 1;
  umidSolo = umidadeAtual; // Variavel global para atualizar ThingSpeak.
  delay(300);

  Serial.print("Umidade do solo: ");
  Serial.print(umidadeAtual); // 1 = seco; 0 = umido.
}
